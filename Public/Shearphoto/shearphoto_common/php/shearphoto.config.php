...
array(100, true, 0), //@参数1要生成的宽 （高度不用设，系统会按比例做事），   @参数2：是否为该图加水印，water参数要有水印地址才有效true或false  @参数3：图片后面添加字符串 （用以区分其他截图名称),填写字符串，不要含中文，不然能又鸡巴痛了，不定义的话默认为"0"

array(70, true, 0)//你可以继续增加多张照片,也可以删除不要的，默认是3张哦
